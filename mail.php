...
$thanksPage = "https://lifetimes-hair.jp/lp/lifetimesgym/thanks.html";
...
$require = array('お問い合わせ内容','お名前','ふりがな','Email','電話番号','住所');
...
──────────────────────
若返り専門パーソナルトレーニング　LIFETIMES GYM
〒860-0832
熊本県熊本市中央区萩原町 9-94
ウッディマンション萩原
TEL：096-288-6655
E-mail:karada.kumamoto@gmail.com
URL: http://lifetimesgym.com/
──────────────────────
			...
			<section class="section contact-box01">
				...
				<div class="section-header">
					...
					<div class="section-block">
						...
						<?php if($empty_flag == 1){ ?>
						<div align="center">
						<h4 class="title align-center">入力にエラーがあります。下記をご確認の上「戻る」ボタンにて修正をお願い致します。</h4>
						<?php echo $errm; ?><br /><br /><input type="button" class="btn btn--glay btn--cubic btn--shadow" value=" 前画面に戻る " onClick="history.back()">
						</div>
						<?php }else{ ?>
						<h3 class="title size-middle">確認画面</h3>
						<p align="center" class="title align-center">以下の内容で間違いがなければ、「送信する」ボタンを押してください。</p>
						<form action="<?php echo h($_SERVER['SCRIPT_NAME']); ?>" method="POST">
						<table class="formTable">
						<?php echo confirmOutput($_POST);//入力内容を表示?>
						</table>
						<p align="center" class="align-center"><input type="hidden" name="mail_set" value="confirm_submit">
						<input type="hidden" name="httpReferer" value="<?php echo h($_SERVER['HTTP_REFERER']);?>">
						<input type="submit" class="btn btn--blue btn--cubic btn--shadow" value="　送信する　">
						<input type="button" class="btn btn--glay btn--cubic btn--shadow" value="前画面に戻る" onClick="history.back()"></p>
						</form>
						<?php } ?>
						</div><!-- /formWrap -->
						<!-- ▲ *********** 送信内容確認部　※編集は自己責任で ************ ▲-->
